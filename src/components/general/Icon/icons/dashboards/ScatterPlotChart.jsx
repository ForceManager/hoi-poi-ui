...
function ScatterPlotChart({ color = colors.actionMinor[500], ...props }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" {...props}>
            ...
            <ellipse cx="11.946" cy="13.557" fill="#335B70" rx="1.219" ry="1.217" />
            <ellipse cx="9.037" cy="13.557" fill="#335B70" rx="1.219" ry="1.217" />
            <ellipse cx="5.159" cy="19.783" fill="#335B70" rx="1.219" ry="1.217" />
            ...
            <ellipse cx="14.855" cy="10.443" fill="#335B70" rx="1.219" ry="1.217" />
            <ellipse cx="20.781" cy="10.443" fill="#335B70" rx="1.219" ry="1.217" />
