...
<div style={{ display: 'flex', flexFlow: 'row wrap', gap: 4, alignItems: 'flex-end' }}>
    ...
    <Icon name="callerIdAndroid" />
    <Icon name="callerIdIos" />
</div>;
```
...
<div style={{ display: 'flex', flexFlow: 'row wrap', gap: 4, alignItems: 'flex-end' }}>
    ...
    <Icon name="thickDisabled" /> <span></span>
    <Icon name="warning" />
...
<Fragment>
    <div style={{ display: 'flex', flexFlow: 'row wrap', gap: 4, alignItems: 'flex-end' }}>
        <Icon name="goals" size="large" hasGradient />
        <Icon name="salesOrders" size="large" hasGradient />
        <Icon name="outlook" size="large" hasGradient />
        <Icon name="callerIdIos" size="large" hasGradient />
        <Icon name="callerIdAndroid" size="large" hasGradient />
    </div>
    <div style={{ display: 'flex', flexFlow: 'row wrap', gap: 4, alignItems: 'flex-end' }}>
        <Icon name="accounts" hasGradient />
        <Icon name="contacts" hasGradient />
        <Icon name="opportunities" hasGradient />
        <Icon name="group" hasGradient />
        <Icon name="scanCard" hasGradient />
        <Icon name="fields" hasGradient />
